...
\textbf{iv)} Observing the solution one can observe that the solution is an exponential decay away from the coast. The decay is 
$$\eta\propto e^{-y/R},$$
and the solution will thus keep its initial height along the coast. The zonal shape will stay as the initial shape as we keep the $\eta_0$ term. Thus, the solution will be a propagating wave as the initial condition in the zonal-direction, and decay exponentially away from the coast. On the N.H. the propagation will be with the coast to the right. 
